...
void CustomSortFilterProxyModel::initFilterMap(const QMap<filterType, QString> &map)
{
    filtersMap.clear();
...
void CustomSortFilterProxyModel::addFilterRegExp(filterType type, const QString &pattern)
{
